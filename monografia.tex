...
%% Dá uma olhada no curso de Evolução de Software que eu e o Gustavo demos. Tem muita coisa introdutória que seria legal aparecer aqui!
    (revisar)
        ...
        Dessa forma, a Mineração de Repositórios de Software aplica técnicas da Mineração de Dados em dados históricos do desenvolvimento de sistemas de software \cite{workshop-gustavo-aniche}. 
