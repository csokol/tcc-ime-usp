...
\chapter{Arquitetura do MetricMiner} \label{ch:arquitetura}
    ...
    \section{Decisões arquiteturais} \label{sc:arquitetura}
        ...
        \subsection*{Modelo de dados}
            O diagrama da Figura \ref{fig:uml_modelo} exibe as classes que representam o modelo de dados minerados pelo MetricMiner. Todas as classes e relacionamentos representados nesse diagrama são mapeadas em tabelas no banco de dados por meio do Hibernate. 
    ...
    %% modelo de dados... destacar: TaskRunner, RunnableTask, RunnableTaskFactory, Metric, MetricFactory
