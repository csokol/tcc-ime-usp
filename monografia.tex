...
\chapter{Conclusão e trabalhos futuros} \label{ch:conclusao}
        ...
        \begin{itemize}
            ...
            \item {\bf Usabilidade da interface web}: é preciso tornar a interface mais informativa ao usuário. Não é claro, por exemplo, que as tarefas pesadas de mineração são executadas assíncronamente.
        \end{itemize}
