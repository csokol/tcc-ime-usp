...
\chapter{Mineração de Repositórios de Software} \label{ch:conceitos}
    ...
    \section{Mineração de repositórios de software}
        ...
        em relação às questões de pequisa que dirigem esses estudos. Foram criadas duas classes
        ...
        Neste trabalho, os autores descrevem um modelo de dados para armazenar informações do
